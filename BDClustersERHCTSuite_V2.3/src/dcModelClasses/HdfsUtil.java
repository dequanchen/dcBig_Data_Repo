...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	public static String getNameNode1ServiceStateByWeb (String bdClusterName){
		String tempLocalWorkignFileAndPathName = "C:\\BD\\BDProd\\HDFS\\tempNameNode1State.txt";
	...
	public static String getNameNode1ServiceState (String bdClusterName){
		String tempLocalWorkignFileAndPathName = "C:\\BD\\BDProd\\HDFS\\tempNameNode1State.txt";
		prepareFile (tempLocalWorkignFileAndPathName,  "Local File For Name Node 1 Service Status of BD Cluster - " + bdClusterName);
		...
		try {
			...
			if (exitVal == 0){	
				...
				if (bdClusterName.equalsIgnoreCase("BDProd")
						|| bdClusterName.equalsIgnoreCase("BDPrd")){						
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN01ConParameters()); 
				}
				if (bdClusterName.equalsIgnoreCase("BDInt")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN01ConParameters()); 
				}
				if (bdClusterName.equalsIgnoreCase("BDDev")) {					
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevEN01ConParameters()); 
				}
				if (bdClusterName.equalsIgnoreCase("BDSbx")
						|| bdClusterName.equalsIgnoreCase("BDSdbx")){
				...
				String hdfsNN1StateFindingFullCmdStr2 = "su hdfs -c 'hdfs haadmin -getServiceState nn1'";
...
public static int runSingleCommand_OnBDCluster (String bdClusterName, String bdNodeName, String singleFullCmdStr){
		...
		try {
			...
			if (bdClusterName.equalsIgnoreCase("BDProd")
				...
				if (bdNodeName.equalsIgnoreCase("EN02")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN02ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN03")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN03ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN04")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN04ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN05")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN05ConParameters()); 
				}
				//if (bdNodeName.equalsIgnoreCase("EN06")){
				//	bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdEN06ConParameters()); 
				//}
				if (bdNodeName.equalsIgnoreCase("MN01")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdMN01ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("MN02")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdMN02ConParameters()); 
				}
			}
			if (bdClusterName.equalsIgnoreCase("BDInt")){
				if (bdNodeName.equalsIgnoreCase("EN01")){
				...
				if (bdNodeName.equalsIgnoreCase("EN02")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN02ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN03")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN03ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN04")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN04ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN05")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN05ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("EN06")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN06ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("MN01")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntMN01ConParameters()); 
				}
				if (bdNodeName.equalsIgnoreCase("MN02")){
					bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntMN02ConParameters()); 
				}
			}
			if (bdClusterName.equalsIgnoreCase("BDDev")) {					
				if (bdNodeName.equalsIgnoreCase("EN01")){
				...
				//if (bdNodeName.equalsIgnoreCase("EN02")){
				//	bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevEN02ConParameters()); 
				//}
				...
				//if (bdNodeName.equalsIgnoreCase("MN02")){
				//	bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevMN02ConParameters()); 
				//}
			}
			if (bdClusterName.equalsIgnoreCase("BDSbx")
					|| bdClusterName.equalsIgnoreCase("BDSdbx")){
	...
	public static void intraTDHVersion2CopyHdfsFolderOrFile (String srcClusterName, String srcFolderOrFileFullPathAndName, 
		...
		if (srcClusterName.equalsIgnoreCase("BDProd")
		...
		if (srcClusterName.equalsIgnoreCase("BDInt")){
		...
		if (srcClusterName.equalsIgnoreCase("BDDev")){
		...
		if (destClusterName.equalsIgnoreCase("BDProd")
		...
		if (destClusterName.equalsIgnoreCase("BDInt")){
		...
		if (destClusterName.equalsIgnoreCase("BDDev")){
		...
		try {
			...
			if (tdhVersionClusterName_4Copying.equalsIgnoreCase("BDProd")
							|| tdhVersionClusterName_4Copying.equalsIgnoreCase("BDPrd")){						
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdMN02ConParameters()); 
			}
			if (tdhVersionClusterName_4Copying.equalsIgnoreCase("BDInt")){
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntMN02ConParameters()); 
			}
			if (tdhVersionClusterName_4Copying.equalsIgnoreCase("BDDev")) {					
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevEN01ConParameters()); 
			}
...
//		}
		...
		try {
			...
			if (tdhVersionHighClusterName.equalsIgnoreCase("BDProd")
							|| tdhVersionHighClusterName.equalsIgnoreCase("BDPrd")){						
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdProdMN02ConParameters()); 
			}
			if (tdhVersionHighClusterName.equalsIgnoreCase("BDInt")){
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntMN02ConParameters()); 
			}
			if (tdhVersionHighClusterName.equalsIgnoreCase("BDDev")) {					
				bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevEN01ConParameters()); 
			}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////	
	public static void moveHdfsFolderOrFile (String srcClusterName, String srcFolderOrFileFullPathAndName, 
		...
		try {
			ConfigureULWResources currConfigureBDResource  = new ConfigureULWResources();
			ULServerCommandFactory bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdIntEN01ConParameters());
	...
	public static void copyHdfsFolderOrFile (String srcClusterName, String srcFolderOrFileFullPathAndName, 
		...
		try {
			ConfigureULWResources currConfigureBDResource  = new ConfigureULWResources();
			ULServerCommandFactory bdENCommFactory = new ULServerCommandFactory(currConfigureBDResource.getBdDevEN01ConParameters()); //getBdIntEN02ConParameters..getBdProdEN02ConParameters...getBdIntEN01ConParameters()
	...
	public static int runScriptFile_OnBDCluster (String localScriptFileFullPathAndName, 
        ...
        //2.(4) Step #4: Step 4 - Run script file inside BDIntEN01 folder - '/home/hdfs/' 
        if (exitVal !=0 ){
			return exitVal;
		} else {
			Hdfs tempHdfs = new Hdfs ("BDInt");
			//Sqoop tempSqoop = new Sqoop ("BDInt");
        ...
        //2.(5) Step #4: Step 5 - Remove sqoop import script file inside BDIntEN01 folder - '/home/hdfs/' 
        if (exitVal !=0 ){
			return exitVal;
		} else {
