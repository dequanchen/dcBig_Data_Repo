...
public class Hdfs {
	...
	private static String hdfsScriptFilesFolder = "../BDClustersERHCTSuite_V2.3/src/LinuxScriptFiles/Hdfs/"; //"C:\\BD\\BDInt\\Hdfs\\";
...
//	}//createRemoveFile_FromHdfs_ScriptFileForPutty	
	...
	public String createBDIntBackupFromBDProd_ScriptFileForPutty (String tgtDocType, String yrMonthDay) throws IOException{	
        ...
        String startHdfsScriptFilePathAndName = hdfsScriptFilesFolder + this.bdClusterName.toUpperCase() + "_" + tgtDocType + "_BDIntBackup_FromBDProd_Script.txt";			
		FileWriter outStream = new FileWriter(startHdfsScriptFilePathAndName);
	    PrintWriter output = new PrintWriter (outStream);	
