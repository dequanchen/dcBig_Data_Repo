...
* Date: 12/13-18/2014; 3/14/2016 
*/ 


public class C3_dcTestStorm_UsingFlumeAndES {
	...
	// /usr/lib/flume/bin/flume-ng (<=TDH2.1.11) ==> /usr/hdp/2.3.4.0-3485/flume/bin/flume-ng (TDH2.3.4)
...
//		}	
		...
		for (int i = 0; i < clusterENNumber; i++){ //bdClusterEntryNodeList.size()..1..clusterENNumber	
			...
			String flumeNgInitiateStr = "/usr/hdp/2.3.4.0-3485/flume/bin/flume-ng agent ";						
			...
			String stormInitiateStr = "/usr/hdp/2.3.4.0-3485/storm/bin/storm ";	
			String stormTopologyStartCmd =  stormInitiateStr + " jar "
							+  enServerStormJarFilePathAndName + " topology.TestFlumeTopology "
							+ flumeHostName + " " + enServerStormTestDataFilePathAndName + " & sleep 35";
