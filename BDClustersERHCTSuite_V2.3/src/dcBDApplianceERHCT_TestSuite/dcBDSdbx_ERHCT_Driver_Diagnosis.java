...
public class dcBDSdbx_ERHCT_Driver_Diagnosis {	
	private static int testingTimesSeqNo = 5;
	...
	public static void main(String[] args) throws Exception {
		...
		String esClusterName = "bdintelasticsearch";
		...
		//8a. Testing Storm Using HBase
		System.out.println("*** Intializing Testing Storm Using HBase on BD '" + bdClusterName + "' Cluster... \n");
		String localStormTestDataFileName2 = "dcFSETestData.txt";
		String stormTestedFilesFolder2 = "/data/test/Storm/";
		String hbaseTableName = "employee";
		String localStormJarFileName2 = "StormTest-0.0.1-SNAPSHOT-jar-with-dependencies.jar";		
				
		uatParametersArray[4] = localStormTestDataFileName2;		
		uatParametersArray[5] = stormTestedFilesFolder2;	
		uatParametersArray[6] = hbaseTableName;
		uatParametersArray[7] = localStormJarFileName2;
		
		//C4_dcTestStorm_UsingHBase.main(uatParametersArray);	
...
//		writeDataToAFile(dcTestBdCluster_RecFilePathAndName, currNotingMsg, false);		
