...
* Date: 11/20-30/2014, 12/1-4/2014; 2/4/2015; 2/26/2015; 3/14/2016
*/ 
...
public class B3_dcTestHBase_LoadingAndQuerying {
	...
	//Add:  sb.append(exportHcatClassPath + ";\n"); //For TDH2.3.4  for HFile and Pig-through-HCatalog test scenarios
	...
	public static void run() throws Exception {
	    ...
	    sb.append("-----**********  Records of Mayo Clinic Un-Kerberized '"+ bdClusterName +"' Cluster HBase (HCat) Enterprise-Readiness Certification Testing Results  **********----- \n" );		    
...
//		}
		...
		String pigShellInitiateStr = "/usr/hdp/2.3.4.0-3485/pig/bin/pig -stop_on_failure -useHCatalog -e ";
		...
		for (int i = 0; i < clusterENNumber; i++){ //bdClusterEntryNodeList.size()..1	
		    ...
		    sb.append("hadoop fs -chown -R hbase:hdfs " + hbaseHdfsHomeFolder + "; \n");
		    sb.append("hadoop fs -chmod -R 750 " + hbaseTestedTablesInfoFolder + "; \n");
		...
		for (int i = 0; i < clusterENNumber; i++){ //bdClusterEntryNodeList.size()..1..clusterENNumber	
			...
			if (hiveTableRowCount != 0) {
				...
				//	exportHadoopClassPath = "export HADOOP_CLASSPATH=/etc/hbase/conf:/usr/hdp/2.3.4.0-3485/hbase/hbase-0.94.6.1.3.2.0-111-security.jar:/usr/hdp/2.3.4.0-3485/zookeeper/zookeeper.jar";
				//	setHiveAuxJarsPathStr = "SET hive.aux.jars.path=file:///etc/hbase/conf/hbase-site.xml,file:///usr/hdp/2.3.4.0-3485/hive/lib/hive-hbase-handler-0.11.0.1.3.2.0-110.jar,file:///usr/hdp/2.3.4.0-3485/hbase/hbase-0.94.6.1.3.2.0-110-security.jar,file:///usr/hdp/2.3.4.0-3485/zookeeper/zookeeper-3.4.5.1.3.2.0-110.jar, file:///usr/hdp/2.3.4.0-3485/hive/lib/guava-11.0.2.jar";
				//}				
				...
				//date +"%T";
				// /usr/hdp/2.3.4.0-3485/hive/bin/hive -e "INSERT OVERWRITE TABLE  emp1 select * from employee_sd"&
				//sleep 75;
				//date +"%T";
		...
		for (int i = 0; i < clusterENNumber; i++){ //bdClusterEntryNodeList.size()..1..clusterENNumber	
			...
			//String loadHFilesToHBaseTableCmd = "hadoop jar /usr/hdp/2.3.4.0-3485/hbase/hbase-0.94.6.1.3.2.0-110-security.jar completebulkload " + hbaseTestedTablesInfoFolder + hcatTableName_forHFilesStoring + " " + hbaseTableName_forloadingHFiles;
...
//			System.out.println (" --- address: " + address);
	...
	private static String generateECGTestDataSqoopImportToHBaseFullCmd (String sqlServerDBName, 
	    ...
	    String sqoopCmdLeft_5Q = " import --connect \"jdbc:sqlserver://ROPEIM802Q.mayo.edu\\\\PROJDEV;database="
