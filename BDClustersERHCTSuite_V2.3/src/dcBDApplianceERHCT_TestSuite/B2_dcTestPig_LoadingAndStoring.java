...
public class B2_dcTestPig_LoadingAndStoring {
	...
	// /usr/lib/pig/bin/pig (<=TDH2.1.11) ==> /usr/hdp/2.3.4.0-3485/pig/bin/pig (TDH2.3.4)
...
//		}	
		...
		for (int i = 0; i < clusterENNumber; i++){ //bdClusterEntryNodeList.size()..1..clusterENNumber	
			...
			String pigShellInitiateStr = "/usr/hdp/2.3.4.0-3485/pig/bin/pig -e ";						
