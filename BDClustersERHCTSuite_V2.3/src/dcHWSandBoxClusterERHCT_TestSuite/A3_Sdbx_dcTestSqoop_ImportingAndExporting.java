...
* Date: 11/10-11/2014; 2/22/2016 
*/ 


public class A3_Sdbx_dcTestSqoop_ImportingAndExporting {
	...
	// /usr/lib/sqoop/bin/sqoop (<=TDH2.1.11) ==> /usr/bin/sqoop or /usr/hdp/2.3.2.0-2950/sqoop/bin/sqoop (TDH2.3.2/4) //2.3.2.0-2950...2.3.4.0-3485
...
//			String sqoopExportToTableName = exportTableName2;
	...
	private static String generateECGTestDataSqoopExportFullCmd (String hdfsSrcFolderPath, String sqoopExportToTableName) {
	    ...
	    String sqoopCmdLeft_5Q = "/usr/bin/sqoop export --connect \"jdbc:sqlserver://ROPEIM802Q.mayo.edu\\\\PROJDEV;database=EDT_BigData\" --username TU05303 --password vbfgrt45";
	...
	private static String generateECGTestDataSqoopImportFullCmd (String tempSqlQueryWhereClause, String importColumnListStr, String hdfsTgtFolderPath) {
	    ...
	    String sqoopCmdLeft_5Q = "/usr/bin/sqoop import --connect \"jdbc:sqlserver://ROPEIM802Q.mayo.edu\\\\PROJDEV;database=EDT_BigData\" --username TU05303 --password vbfgrt45";
	    //System.out.println("\n--*1-- sqoopCmdLeft_5Q is : \n" + sqoopCmdLeft_5Q);
