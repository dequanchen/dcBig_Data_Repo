...
* Date: 11/06-10, 22-24/2014; 2/19-20/2016 
*/ 


public class A1_Sdbx_dcTestHDFS_WritingAndReading {
...
//		}	
		...
		for (int i = 0; i < clusterENNumber; i++){ //clusterENNumber..bdClusterEntryNodeList.size()..1	
			...
			String hdfsTestedTablesFolder = "/data/test/HDFS";
		    ...
		    sb.append("hadoop fs -mkdir -p " + hdfsTestedTablesFolder + "; \n");
		    //sb.append("hadoop fs -chown hdfs:bduser " + hdfsTestedTablesFolder + "; \n");
		    sb.append("hadoop fs -chmod -R 750 " + hdfsTestedTablesFolder + "; \n");
		    sb.append("exit; \n");
