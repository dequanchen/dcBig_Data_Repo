...
public class dcTestWebHBase_v1 {
	private static String bdClusterName = "BDTest2"; //BDDev...BDSdbx...BDTest2...BDProd2
	...
	public static void main(String[] args) {		
		...
		String curlCmd_R_F5 = "-k -u " + userName + ":" + userPW + " " + f5BalancerIPAddressAndPort + "/gateway/" + bdClusterIdName + "/hbase/employee_knox_webhbase1/101/cfs:firstName > \"" + curlCmdEceTempResultFilePathAndName + "\"";
