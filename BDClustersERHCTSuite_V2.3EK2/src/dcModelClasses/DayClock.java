...
//		System.out.print(diffSeconds + " seconds.");
	...
	public static String convertDateTimeToTimeStampString (String aDateTime) throws Exception {
		SimpleDateFormat format = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
		 
		Date datetime = format.parse(aDateTime);
		long datatimeStamp = datetime.getTime();
		
		String timeStampStr = Long.toString(datatimeStamp);
		return timeStampStr;		
	}//end convertDateTimeToTimeStampString
