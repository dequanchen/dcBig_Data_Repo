...
public class HiveViaKnoxOrF5ConnectionFactory {
	...
	public HiveViaKnoxOrF5ConnectionFactory(String currKnoxNodeFQD, int aBDClusterKnoxPort, String aHiveDBName, 
			String aLocalKnoxGatewayTrustStore, String aLocalKnoxGatewayTrustStorePassword, String bdClusterIdName,
			String aUsername, String aPassword, String bdKnoxOrF5HiveContextPath) {
		...
		this.url =  String.format( "jdbc:hive2://" + this.knoxGatewayHost + ":" + this.knoxGatewayPort + "/" + this.hiveDBName 
				+ ";ssl=true;"	      		
	      		+ "transportMode=http;"	      		
	      		+ "httpPath=" + bdKnoxOrF5HiveContextPath + ";"
