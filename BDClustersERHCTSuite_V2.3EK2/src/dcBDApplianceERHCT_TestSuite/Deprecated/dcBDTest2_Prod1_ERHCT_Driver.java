...
import dcBDApplianceERHCT_TestSuite.C4a_dcTestStorm_UsingFlume;
import dcBDApplianceERHCT_TestSuite.C5_dcTestOozie_Workflow;
import dcBDApplianceERHCT_TestSuite.C6_dcTestKafka_TpcDC_MsgPC;
import dcBDApplianceERHCT_TestSuite.E_dcGet_IntegratedERHCTReport;
import dcModelClasses.DayClock;

/**
* Author:  Dequan Chen, Ph.D.;  CopyRight By: Mayo Clinic
* Date: 11/06-30/2014, 12/1-4/2014; 1/5/2016 (Kerberos); 1/14/2016; 2/29/2016
*/ 

public class dcBDTest2_Prod1_ERHCT_Driver {	
	private static int testingTimesSeqNo = 4;
	private static String bdClusterName = "BDTest2"; //BDTest2...BDTest2...BDTest2...
	private static String bdApplianceUATestResultsParentFolder = "C:\\BD\\BD_ERHCT\\";	
	
	
	public static void main(String[] args) throws Exception {
		String loginUserAccountName = "wa00336";
...
//			System.exit(0);
//		}	
		String loginUserADPassWd = "changeme";
		...
		//7. Testing Spark RDD Creation, Transformation, Action and Saving 
		...
		//9.Testing ElasticSearch Indexing and Searching  
		...
		//10. Testing Solr Indexing and Searching  
		...
		String localSolrConfigFolderName = "C:\\BD\\BD_ERHCT\\solr\\";
		...
		//11.Testing Storm Using Flume & ES 
		...
		if (bdClusterName.equalsIgnoreCase("BDTest2")
				|| bdClusterName.equalsIgnoreCase("BDTest2") || bdClusterName.equalsIgnoreCase("BDPrd")
		...
		String localOozieJarFileName = "StormTest-0.0.2-SNAPSHOT-jar-with-dependencies.jar";//"StormTest-0.0.2-SNAPSHOT-jar-with-dependencies.jar";//"WordCount-0.0.1-SNAPSHOT-jar-with-dependencies.jar";				
		...
		String localKafkaJarFileName = "StormTest-0.0.2-SNAPSHOT-jar-with-dependencies.jar";
		...
		//14. Testing Knox-LDAP-AD Secured Hadoop Services (WebHDFS, WebHcat, ....)
		...
		String localKnoxOozieJarFileName = "StormTest-0.0.2-SNAPSHOT-jar-with-dependencies.jar";		
...
//		D1d_dcTestKnox_WebHbaseLargeInsert_HiveJDBC_Oozie.main(uatParametersArray);
		...
		//15. Generating All-In-One Integrated Report File
