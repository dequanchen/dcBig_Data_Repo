...
public class D1b_dcTestKnox_SharedKxServers_SupportedRestServices {
	...
	public static void run() throws Exception {
		...
		for (int i = secureHiveJDBCViaKnoxService_Start; i < secureHiveJDBCViaKnoxServiceNumber; i++){
			...
			final HiveViaKnoxConnectionFactory_Old aHiveViaKnoxConnFactory = 
					new HiveViaKnoxConnectionFactory_Old(currKnoxNodeFQDN, currBdClusterGatewayPortNum, 
