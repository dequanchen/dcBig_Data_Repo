package dcBDApplianceERHCT_TestSuite.Deprecated;
...
* Date: 3/11/2016; 5/4/2016
*/ 

public class D1deprecated_dcTestKnox_SharedKxServers_SupportedRestServices {
...
//		System.out.println("*** On '" + currClusterKnoxNodeName + "'server, created enServerScriptFileDirectory: " + enServerScriptFileDirectory);
		...
		for (int i = clusterKNNumber_Start; i < clusterKNNumber; i++){ //bdClusterKnoxNodeList.size()..1..clusterKNNumber	
			String tempENName = bdClusterKnoxNodeList.get(i).toUpperCase();			
			System.out.println("\n--- (" + (i+1) + ") Moving Test Data and Appending Test Data To Knox Server Node: " + tempENName);
			
			BdNode kBDNode = new BdNode(tempENName, bdClusterName);
			ULServerCommandFactory bdENCmdFactory = kBDNode.getBdENCmdFactory();
			ULServerCommandFactory bdENRootCmdFactory = kBDNode.getBdENRootCmdFactory();
		...
		for (int i = clusterKNNumber_Start; i < clusterKNNumber; i++){ //bdClusterKnoxNodeList.size()..1..clusterKNNumber
			...
			String tempENName = bdClusterKnoxNodeList.get(i).toUpperCase();			
			System.out.println("\n--- (" + (i+1) + ") Testing WebHDFS Through Knox Node: " + tempENName);
			...
			prepareFile (knoxWebHdfsScriptFullFilePathAndName,  "Script File For Testing Knox WebHDFS on '" + bdClusterName + "' Entry Node - " + tempENName);
			...
			tempClock = new DayClock();				
			String tempTime1_end = tempClock.getCurrentDateTime();		
			String time1Used = DayClock.calculateTimeUsed(tempTime1_start, tempTime1_end); 
			...
			if (currTestScenarioSuccessStatus) {
				...
				testRecordInfo = "*** Success - # (" + totalTestScenarioNumber + ") Test Scenario:"
						...
						+ "\n          at the time - " + tempTime1_end + " and Time Used: " + time1Used
		...
		//5.2 Login to Current Hadoop Cluster Knox Servers and Perform Data Writing/Reading to WebHDFS file 
		...
		for (int i = clusterKNNumber_Start; i < clusterKNNumber; i++){ //bdClusterKnoxNodeList.size()..1..clusterKNNumber
			...
			String currClusterKnoxWebHDFSHttpsURL = "https://" + currKnoxNodeFQDN + ":8442/gateway/" + bdClusterKnoxIdName + "/webhdfs";
			...
			prepareFile (knoxWebHdfsScriptFullFilePathAndName2,  "Script File For Testing Knox WebHDFS on '" + bdClusterName + "' Entry Node - " + tempENName);
			...
			tempClock = new DayClock();				
			String tempTime2_end = tempClock.getCurrentDateTime();		
			String time2Used = DayClock.calculateTimeUsed(tempTime2_start, tempTime2_end); 
			...
			if (currTestScenarioSuccessStatus2) {
				...
				testRecordInfo2 = "*** Success - # (" + totalTestScenarioNumber + ") Test Scenario:"
						...
						+ "\n          on BigData '" + bdClusterName  + "' Cluster From Entry Node - '" + tempENName + "'"
						+ "\n          at the time - " + tempTime2_end + " and Time Used: " + time2Used
...
//			
//			String activeWebHCatHttpURL = currBdCluster.getActiveWebHdfsHttpAddress().replace(":50070", ":50111").replace("webhdfs", "templeton");
//			
...
//		    sb.append("kdestroy;\n");
//		    
//		    String knoxWebHCatScriptFullFilePathAndName = scriptFilesFoder + "dcTestKnox_WebHCatScriptFile_Curl.sh";			
//			prepareFile (knoxWebHCatScriptFullFilePathAndName,  "Script File For Testing Knox WebHCat on '" + bdClusterName + "' Entry Node - " + tempENName);
//			
...
//			
//			tempClock = new DayClock();				
//			String tempTime3_end = tempClock.getCurrentDateTime();		
//			String time3Used = DayClock.calculateTimeUsed(tempTime3_start, tempTime3_end); 
//			
...
//						+ "\n          on BigData '" + bdClusterName + "' Cluster From Entry Node - '" + tempENName + "'"
//						+ "\n          at the time - " + tempTime3_end + " and Time Used: " + time3Used
...
//		
//		
//		//6.2 Login to Current Hadoop Cluster Knox Servers and Perform HCatalog DDL operation 
...
//					
//			String currClusterKnoxWebHCatHttpsURL = "https://" + currKnoxNodeFQDN + ":8442/gateway/" + bdClusterKnoxIdName + "/templeton";
//			
//			//(2) Generate WebHDFS cmds:
...
//		    sb.append("kdestroy;\n");
//		    
//		    String knoxWebHCatScriptFullFilePathAndName2 = scriptFilesFoder + "dcTestKnox_WebHCatScriptFile_Curl2.sh";			
//			prepareFile (knoxWebHCatScriptFullFilePathAndName2,  "Script File For Testing Knox WebHCat on '" + bdClusterName + "' Entry Node - " + tempENName);
//			
...
//			
//			tempClock = new DayClock();				
//			String tempTime4_end = tempClock.getCurrentDateTime();		
//			String time4Used = DayClock.calculateTimeUsed(tempTime4_start, tempTime4_end); 
//			
...
//						+ "\n          on BigData '" + bdClusterName + "' Cluster From Entry Node - '" + tempENName + "'"
//						+ "\n          at the time - " + tempTime4_end + " and Time Used: " + time4Used
...
//			prepareFile (knoxWebHBaseScriptFullFilePathAndName,  "Script File For Testing Knox WebHBase on '" + bdClusterName + "' Entry Node - " + currClusterKnoxNodeName);
//			
...
//			
//			tempClock = new DayClock();				
//			String tempTime5_end = tempClock.getCurrentDateTime();		
//			String time5Used = DayClock.calculateTimeUsed(tempTime5_start, tempTime5_end); 
//			
...
//						+ "\n          on BigData '" + bdClusterName + "' Cluster From Entry Node - '" + currClusterKnoxNodeName + "'"
//						+ "\n          at the time - " + tempTime5_end + " and Time Used: " + time5Used
...
//		int secureWebHbaseThroughKnoxServiceNumber = 2; //1..2
...
//			prepareFile (knoxSecureWebHBaseScriptFullFilePathAndName,  "Script File For Testing Knox WebHBase on '" + bdClusterName + "' Entry Node - " + currClusterKnoxNodeName);
//			
//			String webHBaseTestingCmds = sb.toString();
...
//		//    via cURL cmds and WebHbase HTTP URL determined by name node status
//		int secureWebHbaseThroughKnoxServiceNumber2 = 2; //1..2
...
//		}//end for of 9
		...
		currNotingMsg += "\n***** Done - Testing Knox Controlled WebHDFS (cURL), WebHCat, WebHBase, Hive JDBC.... on '" + bdClusterName + "' Cluster from Knox Server Node(s)!";
