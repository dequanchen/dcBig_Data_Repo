...
public class dcBDProd3_ERHCT_Driver_Diagnosis {	
	////Use -Djava.net.preferIPv4Stack=true JVM system property to resolve java.net.SocketException: Permission denied
	private static int testingTimesSeqNo = 2;
	private static String bdClusterName = "BDProd3";
