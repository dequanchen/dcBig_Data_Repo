...
public class D1_dcTestKnox_SharedKxServers_SupportedRestServices {
...
//		System.out.println("*** On '" + currClusterKnoxNodeName + "'server, created enServerScriptFileDirectory: " + enServerScriptFileDirectory);
		...
		for (int i = clusterKNNumber_Start; i < clusterKNNumber; i++){ //bdClusterKnoxNodeList.size()..1..clusterKNNumber
			...
			prepareFile (knoxWebHdfsScriptFullFilePathAndName,  "Script File For Testing Knox WebHDFS on '" + bdClusterName + "' Knox Node - " + tempENName);
			...
			if (currTestScenarioSuccessStatus) {
				...
				testRecordInfo = "*** Success - # (" + totalTestScenarioNumber + ") Test Scenario:"
						...
						+ "\n          on BigData '" + bdClusterName  + "' Cluster From Knox Node - '" + tempENName + "'"
		...
		for (int i = clusterKNNumber_Start; i < clusterKNNumber; i++){ //bdClusterKnoxNodeList.size()..1..clusterKNNumber
			...
			prepareFile (knoxWebHdfsScriptFullFilePathAndName2,  "Script File For Testing Knox WebHDFS on '" + bdClusterName + "' Knox Node - " + tempENName);
...
//			prepareFile (knoxWebHcatScriptFullFilePathAndName,  "Script File For Testing Knox WebHcat on '" + bdClusterName + "' Knox Node - " + tempENName);
//			
...
//			prepareFile (knoxWebHcatScriptFullFilePathAndName2,  "Script File For Testing Knox WebHcat on '" + bdClusterName + "' Knox Node - " + tempENName);
//			
