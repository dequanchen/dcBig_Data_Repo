...
import dcBDApplianceERHCT_TestSuite.Deprecated.D1a_dcTestKnox_SharedKxServers_SupportedRestServices;
import dcBDApplianceERHCT_TestSuite.Deprecated.D1b_dcTestKnox_SharedKxServers_SupportedRestServices;
...
public class dcBDProd2_Int1_ERHCT_Driver {	
	private static int testingTimesSeqNo = 7;
	private static String bdClusterName = "BDProd2"; //BDProd2...BDProd2 == BDProd2
	...
	public static void main(String[] args) throws Exception {
		...
		String testUserAccountName = krbTestUserAuthenticator.getKrbUserName(); // "wa00336"; //wa00336...m041785
		String testUserADPassWd = krbTestUserAuthenticator.getKrbUserPassword(); //"bnhjui89"; //bnhgui89...xxxxx
//		String testUserADPassWd = getUserPromptInputPassWord(testUserAccountName);
//		if (testUserADPassWd.isEmpty()){
//			System.out.println("\n*** Your input password for the test user account is empty, so this program is exitiing... !!! ");
//			System.exit(0);
//		}	
		String internalKinitCmdStr = "";
		internalKinitCmdStr = "echo \"" + testUserADPassWd + "\" | kinit " + testUserAccountName; //  "@MFAD.MFROOT.ORG";
		if (args.length >=4) {
			testingTimesSeqNo = Integer.valueOf(args[0]);
			bdClusterName = args[1];
			String testUserName = args[2];
			String testUserPw = args[3];			
			internalKinitCmdStr = "echo \"" + testUserPw + "\" | kinit " + testUserName;
		...
		D1_dcTestWebHDFS_WebHBase_WebHcat__Knox_F5.main(uatParametersArray);
		 //D1a_dcTestWebHDFS_ActiveNN_Knox_F5.main(uatParametersArray);
		 //D1b_dcTestWebHBase_Stargate_Knox_F5.main(uatParametersArray);
		 //D1c_dcTestHive_WebHCat_Knox_F5.main(uatParametersArray);	
		
		D2_dcTestHiveJDBC__Knox_F5.main(uatParametersArray);
		
		//D3_dcTestWebSpark__Knox_F5.main(uatParametersArray);
