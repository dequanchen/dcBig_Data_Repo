...
public class FileCount_BDDevNew_WebHDFS {
	...
	public static void main(final String[] args) throws IOException, FileNotFoundException, InterruptedException{
	        ...
	        if (nn1ServiceState.equalsIgnoreCase("active")){
	        	//krbNnPrincipal = "nn/hdpr03mn01@MAYOHADOOPTEST1.COM";	
	        	webHdfsURL  = "webhdfs://hdpr03mn01:50070";
	        } else {
	        	//krbNnPrincipal = "nn/hdpr03mn02@MAYOHADOOPTEST1.COM";
	        	webHdfsURL  = "webhdfs://hdpr03mn01:50070";
	        }
            ...
            currSrcHdfsFilePathAndName = "/data/test/HDFS/dcUatDataFile_No1.txt";
