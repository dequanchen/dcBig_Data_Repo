...
* Date: 12/8/2014; 1/5/2016 (Kerberos); 1/14/2016; 2/29/2016; 2/14-20/2017
*/ 

public class dcERHCT_Driver {	
	private static int testingTimesSeqNo = 1;
	private static String bdClusterName = "BDDev"; //BDDev...BDSdbx...BDProd2...BDInt2...BDInt...BDprod
	...
	public static void main(String[] args) throws Exception {
		...
		internalKinitCmdStr = "echo \"" + testUserKDCPW + "\" | kinit " + testUserAccountName; //  
		if (args.length >=4) {
